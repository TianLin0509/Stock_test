...
**短线建议：**（严格按系统提示中的判定标准，明确给出：强烈推荐/推荐/观望/回避，并在括号内给出核心理由）
**中期建议：**（1-3个月维度，严格按系统提示中的判定标准，明确给出：强烈推荐/推荐/观望/回避，并在括号内给出核心理由）
**建议仓位：**（轻仓试探/标准仓位/重仓参与）"""
...
注意：
- 不要列出Top10股票表格（下方已有详细卡片展示，避免重复）
- 这是投资参考，不构成投资建议。请在报告末尾加上简短免责声明。"""
